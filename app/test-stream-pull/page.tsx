...
export default function TestStreamPullPage() {
  return (
    <div className='min-h-screen bg-neutral-900 text-white p-8'>
      <div className='max-w-6xl mx-auto space-y-12'>
        <div className='space-y-2'>
          <h1 className='text-3xl font-bold'>Stream Pull Test</h1>
          <p className='text-neutral-400'>Testing the new stream pull visualization</p>
        </div>
